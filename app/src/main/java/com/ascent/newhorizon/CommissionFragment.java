...
//        comBtn.add("Find out more");
        ...
        comName.add(getString(R.string.comName1));

        comBuddy.add(getString(R.string.comBuddy1));

        comImage.add(R.drawable.tailor);

        comRate.add(getString(R.string.comRate1));

        comDesc.add(getString(R.string.comDesc1));

        comBtn.add(getString(R.string.comBtn));
