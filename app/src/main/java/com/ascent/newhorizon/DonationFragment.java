...
//        donateBtn.add("Back To Blog Page");
        ...
        donateText.add(getString(R.string.header_donate_detail));

        bank.add(getString(R.string.donate_bank));

        holderacc.add(getString(R.string.donate_acc_name));

        acc.add(getString(R.string.donate_acc));

        reference1.add(getString(R.string.donate_code));

        reference2.add(getString(R.string.donate_code2));

        ref.add(getString(R.string.donate_ref));

        donateBtn.add(getString(R.string.donate_back));
